        ...
        <div>
            ...
            <div className="pl-60">
                ...
                <div className="text-left pl-5">
                    ...
                    <h1 className="text-4xl font-sans font-bold">{product.title} {details.memoryPhone} GB</h1>
                    ...
                    <div className="text-left pl-5 pt-5 font-semibold">
                        <span><AirportShuttleIcon /> <em>Доставка: {details.delivery ? "да" : "нет"}</em></span>
                    </div>
                    <h1 className="text-left pl-5 pt-5 font-semibold text-4xl">Коротко о товаре</h1>
                    <div className=" text-left pl-5 pt-5">
                        <p>Гарантийный срок (месяц): {details.waranty}</p>
