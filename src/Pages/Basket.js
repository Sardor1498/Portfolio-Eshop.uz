        ...
        <>
            <div>
                <div className="flex justify-start bg-gray-100 py-4 text-gray-900">
                    <Link className="text-gray-400 font-serif" to="/">
                        Главная
                    </Link>
                    <span className="px-2"> / </span>
                    <Link className="text-gray-400 font-serif" to="/basket">
                        Корзина
                    </Link>
                </div>
                    ...
                    <div className="grid justify-items-center">
                        <div className="w-2/3 flex justify-center">
                            <div className="bg-gray-100 border p-3 rounded-lg">
                                ...
                                <div className="font-bold text-lg font-serif">+998 (99) 790-64-22</div>
                            </div>
                        </div>
                    </div>
                </div>
